...
def proverit_element_na_str(a1, a2, txt, dr)
  if dr.find_elements(a1, a2).size() !=0
    puts("#{txt} на месте")
  else
...
proverit_element_na_str(:xpath, "/html/body/div/h1", "Заголовок 'Ипотечный калькулятор'", driver)
proverit_element_na_str(:xpath, "/html/body/div/div[2]/div[1]/form/div[1]/div[2]/a[1]", "Ссылка 'По стоимости недвижимости'", driver)
proverit_element_na_str(:xpath, "/html/body/div/div[2]/div[1]/form/div[1]/div[2]/a[2]", "Ссылка 'По сумме кредита'", driver)
proverit_element_na_str(:xpath, "/html/body/div/div[2]/div[1]/form/div[2]/div[1]", "Текст 'Стоимость недвижимости'", driver)
proverit_element_na_str(:xpath, "/html/body/div/div[2]/div[1]/form/div[3]/div[1]", "Текст 'Первоначальный взнос'", driver)
proverit_element_na_str(:xpath, "/html/body/div/div[2]/div[1]/form/div[4]/div[1]", "Текст 'Сумма кредита'", driver)
proverit_element_na_str(:xpath, "/html/body/div/div[2]/div[1]/form/div[6]/div[1]", "Текст 'Срок кредита'", driver)
proverit_element_na_str(:xpath, "/html/body/div/div[2]/div[1]/form/div[8]/div[1]", "Текст 'Процентная ставка'", driver)
proverit_element_na_str(:xpath, "/html/body/div/div[2]/div[1]/form/div[9]/div[1]", "Текст 'Тип ежемесячных платежей'", driver)
puts('------------------------')
